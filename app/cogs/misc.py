...
class IntroModal(discord.ui.Modal):
    ...
    def get_footer(self, role: discord.Role) -> typing.Tuple[str, typing.Union[str, None]]:
        footer_name = (
            "Kurzgesagt Official"
    ...
    def edit_embed(self, oldIntroMessage: discord.Message, timezone: str, bio: str, role: discord.Role, user: discord.Member) -> typing.Tuple[discord.Embed, bool]:
    ...
    def create_embed(self, timezone: str, bio: str, role: discord.Role, user: discord.Member) -> discord.Embed:
        """Make and return a introduction embed"""
    ...
    async def reorder(self, intro_channel: discord.TextChannel, role: discord.Role, embed: discord.Embed, user: discord.Member):
